...
function Pagination({ currentPage, totalPage, count }) {
        ...
        <div>
          <nav aria-label="Pagination" className="isolate inline-flex -space-x-px rounded-md ">
            <button
              ...
              className={`
                cursor-pointer relative inline-flex items-center rounded-l-md px-2 py-2 text-gray-700 inset-ring inset-ring-gray-300 hover:bg-gray-50 focus:z-20 focus:outline-offset-0
                ${
